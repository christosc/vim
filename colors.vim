...
#hi MatchParen ctermfg=white cterm=reverse
hi MatchParen ctermbg=lightblue ctermfg=black cterm=reverse,bold guibg=lightblue guifg=black gui=reverse,bold
